// Damaturu
fetch('http://api.weatherapi.com/v1/history.json?key=c900f9d4689c4f91acf105519252004&q=Damaturu&aqi=yes')
.then(res=> res.json())
.then(res =>{
    console.log(res)
...
// Abuja
fetch('http://api.weatherapi.com/v1/history.json?key=c900f9d4689c4f91acf105519252004&q=Abuja&aqi=no')
.then(res=> res.json())
.then(res =>{
    console.log(res);
